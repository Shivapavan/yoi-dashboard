...
const TODAY = '2026-05-04';  // YYYY-MM-DD
...
const BIZ_END   = '2026-05-05T08:59:59.999Z';
...
const CAL_END   = '2026-05-05T04:59:59.999Z';
...
async function fetchTopItems() {
  const url = `${BASE}/reports/echo-pro/xls/sales-summary-by-item-open-and-closed-tickets?start=${encodeURIComponent(TODAY + 'T09:00:00-00:00')}&end=${encodeURIComponent('2026-05-05T08:59:00-00:00')}&locations[]=${LOCATION_ID}&token=${TOKEN}`;
